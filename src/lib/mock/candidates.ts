...
export const mockCandidates: Candidate[] = [
  ...
  },
  {
    ...
    slug: "voto-en-blanco",
    name: "Voto en Blanco",
    party: "Ningún partido",
    color: "#9CA3AF",
    bio: "El voto en blanco es un derecho constitucional. Representa la decisión consciente de no apoyar a ningún candidato. Si gana con mayoría absoluta, se repiten las elecciones con candidatos diferentes.",
    positions: {
      economia: { summary: "Ninguna de las propuestas económicas actuales es suficiente...", quote: "Ninguna propuesta económica actual convence.", page: 0 },
      salud: { summary: "El sistema de salud necesita una reforma real, pero ninguno presenta solución viable.", quote: "Las propuestas de salud son insuficientes.", page: 0 },
      educacion: { summary: "Las propuestas educativas son promesas sin sustento fiscal.", quote: "Promesas educativas sin sustento real.", page: 0 },
      seguridad: { summary: "Ni la mano dura ni el diálogo puro han funcionado.", quote: "Ni mano dura ni diálogo han resuelto la violencia.", page: 0 },
      ambiente: { summary: "El ambientalismo de campaña no es suficiente.", quote: "Las promesas ambientales no sobreviven el primer año.", page: 0 },
      politica_social: { summary: "Los programas sociales perpetúan la dependencia.", quote: "Los subsidios no resuelven la pobreza estructural.", page: 0 },
      politica_exterior: { summary: "La política exterior no debería depender del presidente de turno.", quote: "La política exterior no puede cambiar cada cuatro años.", page: 0 },
      reforma_politica: { summary: "El problema no es la Constitución sino la clase política.", quote: "Reformar con los mismos políticos no funciona.", page: 0 },
      empleo: { summary: "Todos prometen empleo pero ninguno explica cómo financiarlo.", quote: "Las promesas de empleo no tienen respaldo fiscal.", page: 0 },
      tecnologia: { summary: "La transformación digital requiere inversión a largo plazo.", quote: "Las propuestas tecnológicas son marketing electoral.", page: 0 },
    },
  },
]
