...
export function RunoffQuizContainer() {
  ...
  useEffect(() => {
    ...
    api.getRunoffQuestions(sessionId).then((q) => {
      setQuestions(q)
      setLoading(false)
    })
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.submitRunoffMatch(sessionId, quizAnswers)
      router.push("/segunda-vuelta/analyzing")
    } catch {
